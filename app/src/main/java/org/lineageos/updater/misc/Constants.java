...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.okcaros.build.version";
    public static final String PROP_BUILD_VERSION_INCREMENTAL = "ro.build.version.incremental";
    public static final String PROP_DEVICE = "ro.lineage.device";
    public static final String PROP_NEXT_DEVICE = "ro.okcaros.build.device";
    public static final String PROP_RELEASE_TYPE = "ro.okcaros.build.type";
    public static final String PROP_BUILD_ID="ro.build.id";

    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "sys.updater.allow_downgrading";
